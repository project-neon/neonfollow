...
Mark IRON_CUP_2019[] = {
  ...
  // {00.00 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[]}, // R1
    {01.80 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L1
  // {02.05 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L2
  // {00.00 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L3
  // {02.36 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L4
  // {02.74 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L5
  // {03.12 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L6
  // {03.56 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L7
  // {03.80 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L8
    {04.03 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L9
    {04.54 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[FastCurve]}, // L10
    {05.35 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L11
    {05.70 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L12
    {06.60 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L13
    {07.40 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L14
    {08.32 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L15
    {08.90 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L16
    {09.81 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L17
    {11.10 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]}, // L18
    {12.35 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L19
  // {12.73 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L20
  // {12.84 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L21
    {13.57 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L22
    {14.00 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L23
    {14.30 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L24
    {16.95 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L25
  // {17.20 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L26
  // {17.40 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L27
  // {17.63 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L28
  // {17.92 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L29
    {18.30 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L30
    {18.80 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L31
  // {19.15 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L32
  // {19.38 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L33
    {19.65 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L34
    {20.13 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L35
    {20.45 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L36
  // {20.63 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // R2
...
Mark HACKPULICA_RETAS[] = {
    // Distance in meters, Aceleration, Constants of gain (PID)
    {1.3 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {1.6 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {3.1 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {3.5 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {5.0 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {5.4 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {6.8 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {7.2 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {8.7 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {9.08 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {10.55 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {10.9 + OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {11.6 + OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
...
Mark TECH_CHALLENGE[] = { // Distance in meters, Aceleration, Constants of gain (PID)
  {00.30-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Curve]},   // 1 - 00.30
  {00.55+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 2 - 00.70
  {01.95-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 3 - 02.05
  {02.75+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 4 - 02.70
  {04.10-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 5 - 04.00
  {04.45+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 6 - 04.60
  {05.40-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 7 - 05.55
  {06.75+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},  // 8 - 06.55
  {07.90-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 9 - 07.80
  {08.45+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//10 - 08.20
  {09.25-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//11 - 09.00
  // {10.35+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},// 12 - 10.00
  // {10.65-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//13 - 10.30
  {10.65+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},// 12 - 10.00
  {11.15+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//14 - 10.70
  {11.60-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//15 - 11.15
  // {11.70+OFFSET_DESACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//16 - 11.70
  {12.75-OFFSET_ACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Curve]},//17 - 12.70
