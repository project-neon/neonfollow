...
//0,83 coeficiente para mapeamento

Mark IRON_CUP_2019_SAFE[] = {
    // Distance in meters, Aceleration, Constants of gain (PID)
  // {00.00 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[], R1}, // R1
    {01.86 - 0.50, ACCELERATION_UP, GAIN_NUMBER[Straight], 1}, // L1
    {01.86 - 0.05, ACCELERATION_DOWN, GAIN_NUMBER[StraightToSlow], 1}, // L1x
  // {02.02 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowSlowCurve], 2}, // L2
  // {02.13 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowSlowCurve], 3}, // L3
    {02.35 + 0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowSlowCurve], 4}, // L4
  // {02.75 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 5}, // L5
  // {03.12 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 6}, // L6
  // {03.50 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 7}, // L7
  // {03.80 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 8}, // L8
    {03.90 + 0.15, ACCELERATION_UP, GAIN_NUMBER[SlowCurve], 9}, // L9
  //   {04.54 + 0.10, ACCELERATION_UP, GAIN_NUMBER[FastCurve], }, // FastCurveL10 // FastCurve
  //   {05.35 - 0.30, ACCELERATION_UP, GAIN_NUMBER[Straight], 11}, // L11
  //   {05.70 + 0.00, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 12}, // L12
  //   {06.60 -0.30, ACCELERATION_UP, GAIN_NUMBER[Straight], 13}, // L13

  //   // MEXEMOS AQUI
  //   {07.40 +0.00, ACCELERATION_DOWN, GAIN_NUMBER[Curve], 14}, // L14
  //   {08.32 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 15}, // L15
  //   {08.90 +0.00, ACCELERATION_DOWN, GAIN_NUMBER[Curve], 16}, // L16
  //   {09.81 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 17}, // L17
  //   {11.10 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[Curve], 18}, // L18
    
  //   // AINDA NÃO MEXEMOS
  //   {12.35 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 19}, // L19
  // // {12.73 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 20}, // L20
  // // {12.84 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 21}, // L21
  //   {13.57 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 22}, // L22
  //   {14.00 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 23}, // L23
    {14.30 +0.05, ACCELERATION_UP, GAIN_NUMBER[Curve], 24}, // L24
    {16.95 -0.45, 3.0, GAIN_NUMBER[Curve], 25}, // L25
    {16.95 -0.05, ACCELERATION_DOWN, GAIN_NUMBER[StraightToSlow], 25}, // L25x
  // {17.20 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 26}, // L26
  // {17.40 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 27}, // L27
  // {17.63 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 28}, // L28
  // {17.92 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 29}, // L29
    {18.30 +0.15, ACCELERATION_UP, GAIN_NUMBER[SlowCurve], 30}, // L30
  //   {18.80 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 31}, // L31
  // // {19.15 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 32}, // L32
  // // {19.38 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 33}, // L33
  //   {19.65 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve], 34}, // L34
  //   {20.13 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], 35}, // L35
    {20.45 +0.15, ACCELERATION_UP, GAIN_NUMBER[Curve], 36}, // L36
  // {20.63 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight], R2}, // R2
    {FINAL_TARGET_POSITION, ACCELERATION_UP, GAIN_NUMBER[Straight], 100} // 21.20
    // END OF TRACK
};

Mark IRON_CUP_2019_HARDCORE[] = {
    // Distance in meters, Aceleration, Constants of gain (PID)
  // {00.00 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[]}, // R1
    {01.86 - 0.50, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L1
  // {02.02 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowSlowCurve]}, // L2
  // {02.13 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowSlowCurve]}, // L3
    {02.35 + 0.15, ACCELERATION_DOWN, GAIN_NUMBER[Straight]}, // L4
  // {02.75 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L5
  // {03.12 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L6
  // {03.50 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L7
  // {03.80 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L8
    {03.90 + 0.15, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L9
    
    // {04.54 + 0.10, ACCELERATION_UP, GAIN_NUMBER[FastCurve]}, // L10 // FastCurve
    {14.54 + 0.10, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L10 // FastCurve

    {05.35 - 0.30, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L11
    {05.70 + 0.00, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L12
    {06.60 -0.30, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L13

    // MEXEMOS AQUI
    {07.40 +0.00, ACCELERATION_DOWN, GAIN_NUMBER[Curve]}, // L14
    {08.32 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L15
    {08.90 +0.00, ACCELERATION_DOWN, GAIN_NUMBER[Curve]}, // L16
    {09.81 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L17
    {11.10 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[Curve]}, // L18
    
    // AINDA NÃO MEXEMOS
    {12.35 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L19
  // {12.73 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L20
  // {12.84 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L21
    {13.57 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L22
    {14.00 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L23
    {14.30 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L24
    {16.95 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L25
  // {17.20 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L26
  // {17.40 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L27
  // {17.63 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L28
  // {17.92 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L29
    {18.30 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L30
    {18.80 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L31
  // {19.15 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L32
  // {19.38 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L33
    {19.65 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L34
    {20.13 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // L35
    {20.45 +0.15, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]}, // L36
  // {20.63 -0.45, ACCELERATION_UP, GAIN_NUMBER[Straight]}, // R2
    {FINAL_TARGET_POSITION, ACCELERATION_UP, GAIN_NUMBER[Straight]} // 21.20
    // END OF TRACK
};
...
Mark HACKPULICA_RETAS[] = {
    // Distance in meters, Aceleration, Constants of gain (PID)
    {1.3 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {1.6 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {3.1 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {3.5 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {5.0 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {5.4 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {6.8 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {7.2 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {8.7 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {9.08 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {10.55 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
    {10.9 + OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[SlowCurve]},
    {11.6 + OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},
...
Mark TECH_CHALLENGE[] = { // Distance in meters, Aceleration, Constants of gain (PID)
  {00.30-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Curve]},   // 1 - 00.30
  {00.55+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 2 - 00.70
  {01.95-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 3 - 02.05
  {02.75+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 4 - 02.70
  {04.10-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 5 - 04.00
  {04.45+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},      // 6 - 04.60
  {05.40-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 7 - 05.55
  {06.75+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},  // 8 - 06.55
  {07.90-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},   // 9 - 07.80
  {08.45+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//10 - 08.20
  {09.25-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//11 - 09.00
  // {10.35+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},// 12 - 10.00
  // {10.65-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//13 - 10.30
  {10.65+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[FastCurve]},// 12 - 10.00
  {11.15+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//14 - 10.70
  {11.60-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Straight]},//15 - 11.15
  // {11.70+OFFSET_ACCELERATION, ACCELERATION_DOWN, GAIN_NUMBER[Curve]},//16 - 11.70
  {12.75-OFFSET_DESACCELERATION, ACCELERATION_UP, GAIN_NUMBER[Curve]},//17 - 12.70
