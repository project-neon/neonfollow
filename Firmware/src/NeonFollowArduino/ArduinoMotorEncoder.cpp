...
void ArduinoMotorEncoder::configureInterruptMode()
{
    ...
    case ENCODE_TYPE_X1:
        attachInterrupt(digitalPinToInterrupt(_chApin), (voidArgumentFuncPtr) &ArduinoMotorEncoder::_pulseCallback, this, FALLING);
        detachInterrupt(_chBpin);
        break;

    case ENCODE_TYPE_X2:
        attachInterrupt(digitalPinToInterrupt(_chApin), (voidArgumentFuncPtr) &ArduinoMotorEncoder::_pulseCallback, this, CHANGE);
        detachInterrupt(_chBpin);
        break;

    case ENCODE_TYPE_X4:
        attachInterrupt(digitalPinToInterrupt(_chApin), (voidArgumentFuncPtr) &ArduinoMotorEncoder::_pulseCallback, this, CHANGE);
        attachInterrupt(digitalPinToInterrupt(_chBpin), (voidArgumentFuncPtr) &ArduinoMotorEncoder::_pulseCallback, this, CHANGE);
        break;
